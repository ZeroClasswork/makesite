...
[![Go Report Card](https://goreportcard.com/badge/github.com/atleastzero/makesite)](https://goreportcard.com/report/github.com/atleastzero/makesite)
...
- [x] Use the cobra library in my Static Site Generator project. The documentation is located [here](https://pkg.go.dev/github.com/spf13/cobra). My goal is to use it to improve my ssg as a cli tool.
