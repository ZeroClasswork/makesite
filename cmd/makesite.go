...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.makesite.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".makesite" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".makesite")
	}
